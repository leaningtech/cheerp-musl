...
long __syscall_munmap(void* a1, long length);
...
__attribute((cheerp_asmjs))
long __syscall_mmap2(void* a1, long a2, long a3, long a4, long a5, long a6);
...
long __syscall_madvise(long a1,...);
